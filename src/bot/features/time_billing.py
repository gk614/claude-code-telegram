...
async def _classify_via_haiku(events: List[dict], category_keys: List[str]) -> List[str]:
    ...
    try:
        ...
        prompt = (
            ...
            "Гена — фаундер Futura (legal-tech consulting GameDev/CIS/UAE) + строит личный AI-стек GenaOS.\n\n"
            "- work_futura: ЛЮБАЯ продуктивная работа: Futura клиенты/документы/переговоры/продажи/разбор почты, "
            "программирование/фикс/билд GenaOS-бота/инфраструктуры, написание кода, AI-продукты, weekly review, "
            "финансовая работа (cashflow, P&L), скоринг идей. По умолчанию любая «писал/делал/чинил/работал» = work_futura.\n"
            "- family: время с Сашей/Ваней/Игорем, семья, прогулки/еда вместе, домашние дела\n"
            "- training: тренировка, бег, кор-стек, силовая, отжимания, планка, целевая прогулка\n"
            "- health_self: медитация, NSDR, холод, чтение книг (Theory U/Wilber/Замесин), курс Замесина, journaling, дневной сон, NSDR\n"
            "- network: интервью с фаундерами, коучи, новые знакомства, нетворкинг, GameDev tusovka, conference\n"
            "- leisure: CS (Counter-Strike), Netflix, YouTube, скролл соцсетей, бесцельное в телефоне, видеоигры\n"
            "- unknown: ОТКАЗ. Используй только если совсем непонятно (например 'XXX' или 'TODO'). Если есть глагол действия — выбери work_futura или подходящую категорию.\n\n"
            f"Events:\n{bullets}\n\n"
